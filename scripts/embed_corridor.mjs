...
export function buildCorridorBlock(moduleList, returnLines, header) {
  let seenR = false;
  const parts = [];
...
export const DEV_MODULES = [
  ...
  "cmr/tools/lib/materialize.mjs",
  "cmr/tools/lib/emit_c2s.mjs",
  "cmr/tools/c2cmr.mjs",
  "ilcmr/tools/cmr2ilc.mjs",
  "ilcmr/tools/ilc.mjs",
];
export const DEPLOY_MODULES = [
  "cmr/tools/lib/ast.mjs",
  "cmr/tools/lib/parse_cmr.mjs",
  "cmr/tools/lib/materialize.mjs",
  "ilcmr/tools/cmr2ilc.mjs",
...
export const DEPLOY_RETURN = [
  "  return { parseCmr, emitCmr, materialize, decompile, compile,",
  "           decompileLineTicks: () => decompile.lastLineTicks };",
];

const isMain = process.argv[1] && import.meta.url.endsWith(process.argv[1].split("/").pop());
if (isMain) {
  const block = buildCorridorBlock(DEV_MODULES, [
